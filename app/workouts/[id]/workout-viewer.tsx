        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              {workout.source === 'ai' && (
                <span className="ml-3 px-2 py-1 text-xs bg-purple-100 text-purple-700 rounded">
                  AI Generated
                </span>
              )}
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="font-medium">{editedPlan.total_time_minutes} min</div>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="font-medium">{editedPlan.intensity_target || 'Moderate'}</div>
                  </div>
                </div>
                <div className="flex items-center">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="flex space-x-4">
                <button
                  onClick={() => router.push(`/feedback?workout=${workout.id}`)}
                  className="flex-1 py-3 border border-green-500 text-green-600 rounded hover:bg-green-50"
                >
                  <ThumbsUp className="h-5 w-5 inline mr-2" />
                  Looks Good
                </button>
                <button
                  onClick={() => router.push(`/feedback?workout=${workout.id}&rating=low`)}
                  className="flex-1 py-3 border border-red-500 text-red-600 rounded hover:bg-red-50"
                >
                  <ThumbsDown className="h-5 w-5 inline mr-2" />
                  Needs Work
                </button>
              </div>
            </div>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                {workout.clients.injuries && (
                  <div>
                    ...
                    <div className="text-sm text-orange-600">{workout.clients.injuries}</div>
                  </div>
                )}
            ...
            {/* Workout Metadata */}
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="text-lg font-semibold mb-4">Workout Info</h3>
